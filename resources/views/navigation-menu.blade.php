<nav x-data="{ open: false }" class="bg-white border-b border-gray-100" style="background-color: rgba(255, 63, 111, 1);">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center font-bold">
                        <x-jet-application-mark class="block h-9 w-auto" />
                        &nbsp;
                        {{ config('app.name', 'VCOMS') }}
                    </a>
                </div>
